...
public class PacketParticle implements IPacket, IPacketListener<PacketParticle, IPacket>
{
	...
	public void client()
	{
		if(world != Minecraft.getMinecraft().theWorld.provider.getDimension())
			return;
		Minecraft.getMinecraft().theWorld.spawnParticle(particle, pos.xCoord, pos.yCoord, pos.zCoord, motion.xCoord, motion.yCoord, motion.zCoord, params);
	}
}