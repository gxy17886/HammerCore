...
public class PacketManager
{
	...
	/**
	 * Creates a new {@link PacketManager} with passed string as a channel ID or name.
	 * <br>MUST be constructed under FML initialization event, if you want it to work properly.
	 * @param channel
	 * 					A channel that this manager is working on.
	 */
	public PacketManager(String channel)
	{
		if(getManagerByChannel(channel) != null) throw new RuntimeException("Duplicate channel ID for " + channel + " (" + this + ") and (" + getManagerByChannel(channel) + ")!!!");
	 ...
	 * @return A {@link PacketManager} or null, if not exists for passed channel.
	 */
	 ...
	 * 
	 * @param packet The packet class to add listener for
	 * @param listener The listener instance that will listen for packet events
	 */
     ...
     * The {@link IPacketListener} for this packet type should be on the CLIENT side.
     *
    ...
    /**
     * Send this packet to everyone within a certain range of a point.
     * The {@link IPacketListener} for this packet type should be on the CLIENT side.
     *
     * @param packet The packet to send
    ...
    /**
     * Send this packet to everyone within the supplied dimension.
     * The {@link IPacketListener} for this packet type should be on the CLIENT side.
     *
     * @param packet The packet to send
     ...
     * The {@link IPacketListener} for this packet type should be on the SERVER side.
     *
     * @param packet The packet to send
     */
