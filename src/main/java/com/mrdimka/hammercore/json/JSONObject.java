...
public class JSONObject
{
	...
	public JSONObject(JSONTokener readFrom) throws JSONException
	{
		...
		if(object instanceof JSONObject) nameValuePairs = ((JSONObject) object).nameValuePairs;
	...
	public JSONObject(JSONObject copyFrom, String[] names) throws JSONException
	{
		...
		for(String name : names)
		{
			...
			if(value != null) nameValuePairs.put(name, value);
		}
	}
	...
	public JSONObject accumulate(String name, Object value) throws JSONException
	{
		...
		if(current == null) return put(name, value);
	...
	public JSONObject append(String name, Object value) throws JSONException
	{
		...
		if(current instanceof JSONArray) array = (JSONArray) current;
		else if(current == null)
		{
			JSONArray newArray = new JSONArray();
			nameValuePairs.put(name, newArray);
			array = newArray;
		} else throw new JSONException("Key " + name + " is not a JSONArray");
		array.checkedPut(value);
		return this;
	}
	...
	{
		stringer.object();
		for(Map.Entry<String, Object> entry : nameValuePairs.entrySet()) stringer.key(entry.getKey()).value(entry.getValue());
		stringer.endObject();
	}
	
	public static String numberToString(Number number) throws JSONException
	{
		if(number == null) throw new JSONException("Number must be non-null");
	...
	public static String quote(String data)
	{
		...
		try
		{
			...
			return stringer.toString();
		}catch(JSONException e) { throw new AssertionError(); }
	}
	...
	public static Object wrap(Object o)
	{
		...
		try
		{
			...
			else if(o.getClass().isArray()) return new JSONArray(o);
			if(o instanceof Map) return new JSONObject((Map<?, ?>) o);
			if (o instanceof Boolean || o instanceof Byte || o instanceof Character || o instanceof Double || o instanceof Float || o instanceof Integer || o instanceof Long || o instanceof Short || o instanceof String) return o;
