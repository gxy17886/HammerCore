...
public enum TextureFXManager
{
	...
	{
		for(TextureAtlasSprite s : iconMap.values()) if(s instanceof TextureSpriteCustom) ((TextureSpriteCustom) s).resetFX(event instanceof Pre ? 0 : event instanceof Post ? 1 : 2);
