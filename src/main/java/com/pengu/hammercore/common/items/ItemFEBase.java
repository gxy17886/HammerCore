...
public class ItemFEBase extends Item implements IPowerContainerItem
{
	...
	/** change this if you want a different-colored durability bar for this energy item. */
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced)
	{
		...
		if(this instanceof ItemBattery) tooltip.add(I18n.translateToLocal("info.hammercore:changed_mode") + ": " + ((ItemBattery) this).getMode(stack));
	}
	...
	public int receiveEnergy(ItemStack stack, int maxReceive, boolean simulate)
	{
		...
		if(!simulate) setFE(stack, energy + energyReceived);
	...
	public int extractEnergy(ItemStack stack, int maxExtract, boolean simulate)
	{
		...
		if(!simulate) setFE(stack, energy - energyExtracted);
	...
	public class ItemEnergyHolder implements IEnergyStorage, IPowerStorage
	{
		...
		public ItemEnergyHolder(ItemStack stack) { this.stack = stack; }
		@Override public int receiveEnergy(int maxReceive, boolean simulate) { return ItemFEBase.this.receiveEnergy(stack, maxReceive, simulate); }
		@Override public int extractEnergy(int maxExtract, boolean simulate) { return ItemFEBase.this.extractEnergy(stack, maxExtract, simulate); }
		@Override public int getEnergyStored() { return ItemFEBase.this.getEnergyStored(stack); }
		@Override public int getMaxEnergyStored() { return maxFE; }
		@Override public boolean canExtract() { return ItemFEBase.this.maxExtract > 0; }
		@Override public boolean canReceive() { return ItemFEBase.this.maxReceive > 0; }
	}
}